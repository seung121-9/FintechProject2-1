...
<body>
    <div class="container">
        <form method="post" action="/Urban_Village/accommodation/accommodationForm.do" class="form-box">
            <h2>숙소 등록</h2>
            <input type="text" name="accommodation_id" class="input-field" placeholder="숙소 ID" required>
